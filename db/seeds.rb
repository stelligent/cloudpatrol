...
%w{ ec2_instance_age ec2_instances_start_time ec2_instances_stop_time opsworks_stack_age opsworks_layer_age opsworks_instance_age opsworks_app_age cloudformation_stack_age }.each do |setting|
